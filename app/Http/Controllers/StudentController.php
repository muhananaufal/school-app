...
class StudentController extends Controller
{
    ...
    {
        return Inertia::render('Students/Index', ['students' => StudentResource::collection($this->service->getAllStudents()), 'classrooms' => ClassroomResource::collection($this->classroomService->getAllClassrooms())]);
    }
